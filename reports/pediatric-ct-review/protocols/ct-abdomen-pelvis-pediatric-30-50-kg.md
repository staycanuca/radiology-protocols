---
title: CT abdomen-pelvis pediatric de rutină — 30–<50 kg
slug: ct-abdomen-pelvis-pediatric-30-50-kg
modality: ct
category: abdomen
...
- Întrebare clinică abdomino-pelvină pentru care radiologul confirmă CT.
...
series:
- name: Unică; faza și contrastul aprobate înainte de scanare
  start: Dom hepatic
  end: Simfiză pubiană; limite ajustate indicației
  delay: DE CONFIGURAT PE APARAT
  thickness: DE CONFIGURAT PE APARAT
recons:
- acquisition: Unică; faza și contrastul aprobate înainte de scanare
...
# CT abdomen-pelvis pediatric de rutină — 30–<50 kg
...
**30–<50 kg.** Limita inferioară este inclusă, cea superioară exclusă. Pentru grupele de greutate se verifică și vârsta sub 18 ani. Greutatea nu înlocuiește evaluarea dimensiunilor pacientului la alegerea tehnicii.

## Planul examinării

Verifică organele și structurile relevante indicației. Contrastul intravenos și enteric se decid separat.
