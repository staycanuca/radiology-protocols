...
- Traumatism localizat cu suspiciune de fractură claviculară; control selectiv indicat
  clinic.
clinical_status: draft_not_for_clinical_use
images: []
last_updated: '2026-09-15'
modality: rx
notes: Durerea sau suspiciunea de leziune sternoclaviculară/vasculară impun coordonare
  cu echipa clinică, fără manevre forțate.
population: Adult / pediatric — tehnici validate separat
...
- centering: Clavicula completă și extremitățile ei.
  ...
  name: AP claviculă
  position: Ortostatism sau decubit, după stabilitatea pacientului.
  quality: Contur osos și deplasare evaluabile.
- centering: Clavicula în întregime.
  condition: Ghidul RCH pediatric descrie 15° cefalic; confirmare în tehnica locală.
  name: AP axială claviculă
  position: Pacientul rămâne sprijinit; proiecția cefalică este adaptată clinic.
  quality: Proiecție complementară pentru aprecierea deplasării.
tech_params:
...
-   __1. Rezumat Clinic & Indicații__
    ...
    === "Indicații Clinice"
        ...
        - Traumatism localizat cu suspiciune de fractură claviculară; control selectiv indicat clinic.
...
!!! note "Observații Clinice & Tehnice"
    Durerea sau suspiciunea de leziune sternoclaviculară/vasculară impun coordonare cu echipa clinică, fără manevre forțate.
...
**Poziționare:** Ortostatism sau decubit, după stabilitatea pacientului.

**Centrare / acoperire:** Clavicula completă și extremitățile ei.

**Criterii de acceptare:** Contur osos și deplasare evaluabile.

### AP axială claviculă

**Selecție:** Ghidul RCH pediatric descrie 15° cefalic; confirmare în tehnica locală.

**Poziționare:** Pacientul rămâne sprijinit; proiecția cefalică este adaptată clinic.

**Centrare / acoperire:** Clavicula în întregime.

**Criterii de acceptare:** Proiecție complementară pentru aprecierea deplasării.
