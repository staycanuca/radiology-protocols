...
slug: rx-coloana-totala-scolioza
source_mapping:
  clinical_indications:
...
- centering: Coloana completă și reperele necesare măsurătorilor solicitate.
  ...
  name: PA coloană totală în ortostatism
  position: Postură erectă reproductibilă, fără corectare voluntară forțată a curburii.
  quality: Continuitate anatomică și repere vizibile pentru măsurători.
- centering: Acoperire longitudinală conform obiectivului ortopedic.
  condition: Evaluare inițială; repetarea la control se justifică separat.
  name: Profil coloană totală
  position: Ortostatism; brațele poziționate astfel încât să permită evaluarea profilului.
  quality: Profil sagital evaluabil și postură comparabilă.
tech_params:
...
### PA coloană totală în ortostatism

**Selecție:** Parte a setului inițial justificat de radiolog

**Poziționare:** Postură erectă reproductibilă, fără corectare voluntară forțată a curburii.

**Centrare / acoperire:** Coloana completă și reperele necesare măsurătorilor solicitate.

**Criterii de acceptare:** Continuitate anatomică și repere vizibile pentru măsurători.

### Profil coloană totală

**Selecție:** Evaluare inițială; repetarea la control se justifică separat.

**Poziționare:** Ortostatism; brațele poziționate astfel încât să permită evaluarea profilului.

**Centrare / acoperire:** Acoperire longitudinală conform obiectivului ortopedic.

**Criterii de acceptare:** Profil sagital evaluabil și postură comparabilă.
