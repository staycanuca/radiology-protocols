...
- Ingestie de baterie/magneți, obiect necunoscut ori cu risc; copil simptomatic, conform
  evaluării clinice.
clinical_status: draft_not_for_clinical_use
images: []
last_updated: '2026-09-15'
modality: rx
notes: Obiectele cu risc și copilul instabil necesită comunicare imediată. Ingestiile
  cu risc mic pot să nu necesite imagistică. Suspiciunea de aspirație urmează un traseu
  separat.
...
- centering: La copilul mic, gât–torace–abdomen când localizarea este necunoscută;
  ...
  name: Radiografie de localizare
  position: Poziție adaptată vârstei și stării clinice.
  quality: Obiectul și limitele examinate sunt documentate; acoperire fără lacune.
- centering: Regiunea unde diferențierea/localizarea rămâne neclară.
  condition: Selectiv; nu automat pentru toate ingestiile.
  name: Proiecție complementară țintită
  position: Poziționare adaptată segmentului, la decizia radiologului.
  quality: Clarificarea întrebării clinice fără repetarea inutilă a întregului câmp.
tech_params:
...
!!! warning "Ciornă pentru revizuire — nu se utilizează clinic"
    Parametrii aparatului și adaptarea locală trebuie verificate înainte de import.
...
-   __1. Rezumat Clinic & Indicații__
    ...
    === "Indicații Clinice"
        ...
        - Ingestie de baterie/magneți, obiect necunoscut ori cu risc; copil simptomatic, conform evaluării clinice.
...
!!! note "Observații Clinice & Tehnice"
    Obiectele cu risc și copilul instabil necesită comunicare imediată. Ingestiile cu risc mic pot să nu necesite imagistică. Suspiciunea de aspirație urmează un traseu separat.

## Incidențe și criterii de acceptare

### Radiografie de localizare

**Selecție:** Parte a setului inițial justificat de radiolog

**Poziționare:** Poziție adaptată vârstei și stării clinice.

**Centrare / acoperire:** La copilul mic, gât–torace–abdomen când localizarea este necunoscută; limitele se decid clinic.

**Criterii de acceptare:** Obiectul și limitele examinate sunt documentate; acoperire fără lacune.

### Proiecție complementară țintită

**Selecție:** Selectiv; nu automat pentru toate ingestiile.

**Poziționare:** Poziționare adaptată segmentului, la decizia radiologului.

**Centrare / acoperire:** Regiunea unde diferențierea/localizarea rămâne neclară.

**Criterii de acceptare:** Clarificarea întrebării clinice fără repetarea inutilă a întregului câmp.
