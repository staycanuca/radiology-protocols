...
-   __2. Poziționare & Centrare Fascicul__
    ...
    - **Poziție Pacient:** Copil așezat pe scaun, mâna și pumnul STÂNG (convenție internațională conform Atlasului Greulich & Pyle) plasate plat pe detector cu degetele ușor depărtate
...
-   __3. Parametri Tehnici Expunere__
    ...
    |:-----------------|:-------------------------------------|
    | **Tensiune Tub (kV)** | 45 - 50 kV |
    | **Sarcină / Produs Curent-Timp (mAs)** | 1.5 - 2.5 mAs |
    | **Distanță Focar-Film (DFF / SID)** | 100 cm |
