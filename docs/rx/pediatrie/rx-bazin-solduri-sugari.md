...
-   __3. Parametri Tehnici Expunere__
    ...
    |:-----------------|:-------------------------------------|
    | **Tensiune Tub (kV)** | 55 - 60 kV |
    | **Sarcină / Produs Curent-Timp (mAs)** | 3 - 5 mAs |
    | **Distanță Focar-Film (DFF / SID)** | 100 cm |
    | **Grilă Antidifuzoare (Bucky)** | Fără grilă (sau grilă cu raport mic 6:1) |
    | **Dimensiune Focar** | Focar Mic (0.6 mm) |
    | **Camere de Ionizare AEC** | Manual |
    | **Colimare Fascicul** | De la crestele iliace la treimea superioară femurală |
