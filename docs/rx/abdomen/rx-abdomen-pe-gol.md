...
# Rx Abdomen pe Gol (Abdominală Simplă)
...
-   __3. Parametri Tehnici Expunere__
    ...
    | **Sarcină / Produs Curent-Timp (mAs)** | 25 - 40 (AEC) |
    | **Distanță Focar-Film (DFF / SID)** | 100 - 115 cm |
    | **Grilă Antidifuzoare (Bucky)** | Cu grilă antidifuzoare Bucky (raport 10:1 sau 12:1) |
    | **Dimensiune Focar** | Focar Mare (1.0 - 1.2 mm) |
    | **Camere de Ionizare AEC** | Toate cele 3 camere de ionizare sau camerele laterale |
    | **Colimare Fascicul** | De la cupolele diafragmatice până la simfiza pubiană |
