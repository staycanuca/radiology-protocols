...
-   __3. Parametri Tehnici Expunere__
    ...
    |:-----------------|:-------------------------------------|
    | **Tensiune Tub (kV)** | 50 - 55 kV |
    | **Sarcină / Produs Curent-Timp (mAs)** | 2 - 3 (fără grilă) mAs |
    | **Distanță Focar-Film (DFF / SID)** | 100 cm |
    | **Grilă Antidifuzoare (Bucky)** | Fără grilă antidifuzoare |
    | **Dimensiune Focar** | Focar Mic (0.6 mm) |
    | **Camere de Ionizare AEC** | Manual |
    | **Colimare Fascicul** | De la articulația pumnului la extremitatea distală a degetelor |
