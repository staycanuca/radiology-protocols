...
-   __1. Rezumat Clinic & Indicații__
    ...
    === "Ghid Național IRIS"
        ...
        !!! info "Referință Primară: Ghidul Național IRIS (Ordinul MS 1342/2012)"
            - **Capitol Ghid IRIS:** *Traumatisme & Torace*
...
-   __3. Parametri Tehnici Expunere__
    ...
    |:-----------------|:-------------------------------------|
    | **Tensiune Tub (kV)** | 65 - 75 (optimizat pentru contrast osos fin) kV |
    | **Sarcină / Produs Curent-Timp (mAs)** | 10 - 20 (cu grilă Bucky) mAs |
    | **Distanță Focar-Film (DFF / SID)** | 100 - 115 cm |
    | **Grilă Antidifuzoare (Bucky)** | Cu grilă antidifuzoare Bucky |
    | **Dimensiune Focar** | Focar Mic (0.6 mm) |
    | **Camere de Ionizare AEC** | Camera de ionizare homolaterală |
    | **Colimare Fascicul** | Centrată strict pe hemitoracele traumatizat |
