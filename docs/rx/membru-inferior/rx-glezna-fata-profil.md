...
- 'Pe profil: domul talusului este aliniat fără dublu contur (condilii talari suprapuși
  perfect)'
- Vizualizarea bazei celui de-al V-lea metatarsian pentru excluderea unei fracturi
  asociate de avulsie
sid_dff: 100 cm
...
!!! note "Observații Clinice & Tehnice"
    Aplicarea corectă a Criteriilor Ottawa reduce cu peste 30% efectuarea de radiografii inutile de gleznă.
