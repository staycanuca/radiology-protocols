...
breathing: Apnee în expir complet (pentru profil, umerii sunt trași în jos de două
  greutăți mici ținute în mâini)
category: coloana
centering: 'Față: C4 (cartilajul tiroidian), angulație tub 15° cranial; Profil: C4
  perpendicular pe detector; Odontoidă: perpendicular prin centrul cavității bucale
  deschise'
...
- 'Pe odontoidă: dintele axisului centrat între masele laterale ale atlasului, cu
  spații articulare atlanto-axoidiene simetrice'
...
-   __3. Parametri Tehnici Expunere__
    ...
    |:-----------------|:-------------------------------------|
    | **Tensiune Tub (kV)** | 65 - 75 (Față / Odontoidă); 70 - 80 (Profil) kV |
    | **Sarcină / Produs Curent-Timp (mAs)** | 10 - 20 (cu grilă Bucky) mAs |
    | **Distanță Focar-Film (DFF / SID)** | 150 - 180 cm pentru Profil (reduce magnificarea și compensează distanța umăr-coloană); 100 cm pentru Față |
    | **Grilă Antidifuzoare (Bucky)** | Cu grilă antidifuzoare Bucky |
    | **Dimensiune Focar** | Focar Mic (0.6 mm) |
    | **Camere de Ionizare AEC** | Camera centrală de ionizare |
    | **Colimare Fascicul** | De la baza craniului până la vertebra T1 |
